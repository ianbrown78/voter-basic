        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <?php elseif (is_admin_logged_in() && strpos($_SERVER['PHP_SELF'], '/admin/') !== false ): ?>
                    ...
                    <a href="index.php" class="<?php echo $active_page == 'index.php' ? 'hover:text-blue-200 active:text-blue-300 px-2 active' : 'hover:text-blue-200 px-2 active:text-blue-300'?>">Dashboard</a>
                    ...
                    <a href="manage_elections.php" class="<?php echo $active_page == 'manage_elections.php' ? 'hover:text-blue-200 active:text-blue-300 px-2 active' : 'hover:text-blue-200 px-2 active:text-blue-300'?>">Elections</a>
                    <a href="manage_candidates.php" class="<?php echo $active_page == 'manage_candidates.php' ? 'hover:text-blue-200 active:text-blue-300 px-2 active' : 'hover:text-blue-200 px-2 active:text-blue-300'?>">Candidates</a>
                    <a href="manage_users.php" class="<?php echo $active_page == 'manage_users.php' ? 'hover:text-blue-200 active:text-blue-300 px-2 active' : 'hover:text-blue-200 px-2 active:text-blue-300'?>">Voters</a>
                    <a href="results.php" class="<?php echo $active_page == 'results.php' ? 'hover:text-blue-200 active:text-blue-300 px-2 active' : 'hover:text-blue-200 px-2 active:text-blue-300'?>">Results</a>
