...
echo "<script>console.log('Debug Path: " . $active_page . "' );</script>";
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <?php elseif (is_admin_logged_in() && strpos($_SERVER['PHP_SELF'], '/admin/') !== false ): ?>
                    ...
                    <a href="index.php" class="<?php echo $active_page == 'manage_admins.php' ? 'hover:text-blue-200 active:text-blue-300 px-2 active' : 'hover:text-blue-200 px-2 active:text-blue-300'?>">Dashboard</a>
